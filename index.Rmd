...
```{r target-plot}
target <- ggplot(euro_table %>% filter(Year %in% c(2010,2011,2012,2013,2014,2015,2016,2017,2018))) +
  geom_line(aes(x=Year, y=Percentage, color=Country)) +
  geom_point(aes(x=Year, y=Percentage, color=Country), data = euro_table %>% filter(Year == 2020)) +
