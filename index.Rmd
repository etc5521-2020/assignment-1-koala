...
```{r}
energy_types_wide <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2020/2020-08-04/energy_types.csv')
country_totals_wide <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2020/2020-08-04/country_totals.csv')
```
...
energy_types %>%
  ...
  pivot_wider(id_cols = year,
              names_from = type,
              values_from = total) %>%
  mutate(Total_Renewable = Geothermal + Hydro + Nuclear + Other + Solar + Wind) %>%
