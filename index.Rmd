...
#target_energy <- target_energy %>% rename(Country = "unit,indic_eu,geo\time") 
```
...
euro_table$TARGET <- as.numeric(euro_table$TARGET)
```

```{r}
euro_table %>% ggplot(aes(y = Country)) +
              geom_line(aes(x = `2004`))
```
