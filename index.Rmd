...
Now let us look at the presentation of the energy types for each country in Figure \@ref(fig:plot-contribution-country-2016), Figure \@ref(fig:plot-contribution-country-2017), and Figure \@ref(fig:plot-contribution-country-2018). The figures show the proportion of energy types in European countries in 2016,2017, adn 2018 respectively. In general, the majority of countries in Europe rely on thermal energy as the leading supplier of energy needs in their country. However, it is interesting that Albania relies mostly on hydropower. The same is true in Norway, Luxembourg and Georgia.
Meanwhile, Denmark is the country with the most significant wind power utilization, followed by Lithuania and Ireland. The energy intake in France and Slovakia is dominated by nuclear power. As for solar energy, many have adopted it, but the percentage is still small. Not many countries use geothermal, only Italy and Turkey.
...
```{r plot-contribution-country-2016, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="The proportion of each energy type to the total energy production in each country in 2016"}
ggplotly(create_plot(energy_contribution_2016))
```

```{r plot-contribution-country-2017, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="The proportion of each energy type to the total energy production in each country in 2017"}
ggplotly(create_plot(energy_contribution_2017))
```

```{r plot-contribution-country-2018, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="The proportion of each energy type to the total energy production in each country in 2018"}
ggplotly(create_plot(energy_contribution_2018))
```
